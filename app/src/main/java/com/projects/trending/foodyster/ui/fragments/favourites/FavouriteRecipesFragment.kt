...
import com.projects.trending.foodyster.ui.login_activity
import com.projects.trending.foodyster.viewmodels.MainViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.android.synthetic.main.fragment_third_screen.finis
...
class FavouriteRecipesFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (item.itemId==R.id.Logout){
            dbHelper.close()
            val i = Intent(requireContext() , login_activity::class.java)
            startActivity(i)
